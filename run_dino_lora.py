#!/usr/bin/env python3
"""
Script CLI for training and testing object detection models with LoRA.

Usage:
    # Train a model
    python run_dino_lora.py train --dataset-name multiorg --batch-size 8 --max-epochs 100

    # Resume training from a checkpoint
    python run_dino_lora.py train --dataset-name multiorg --resume-from ./checkpoints/last.ckpt

    # Test a model
    python run_dino_lora.py test --ckpt-path ./checkpoints/best.ckpt --dataset-name multiorg
"""
...
from detection_dino_lora.train import train as run_train
from detection_dino_lora.train import test as run_test

torch.set_float32_matmul_precision('high')
def get_train_parser():
    """Parser for training command."""
    parser = argparse.ArgumentParser(description="Train a detection model with LoRA")
...
def main():
    ...
    root_parser = argparse.ArgumentParser(
        description="Training and testing script for object detection with LoRA",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  # Train a model
  python run_dino_lora.py train --dataset-name multiorg --batch-size 8
