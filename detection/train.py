...
from detection.detr_detection import DetectionModel
from detection.utils import get_boundaries
from detection.data import OrganoidDetectionDataset
...
def train(
    ...
    train_loader = DataLoader(
        ...
        collate_fn=DetectionModel.collate_fn,
        pin_memory=True,
...
def test(
    ...
    model = DetectionModel.load_from_checkpoint(ckpt_path)
