...
Usage:
    # Train a model
    python run_detr.py train --dataset-name multiorg --batch-size 8 --max-epochs 100

    # Resume training from a checkpoint
    python run_detr.py train --dataset-name multiorg --resume-from ./checkpoints/last.ckpt

    # Test a model
    python run_detr.py test --ckpt-path ./checkpoints/best.ckpt --dataset-name multiorg
"""
...
Examples:
  # Train a model
  python run_detr.py train --dataset-name multiorg --batch-size 8
