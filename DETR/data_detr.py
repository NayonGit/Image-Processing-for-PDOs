...
from DETR.utils import box_xyxy_to_cxcywh
...
All boxes are returned as normalized cxcywh ∈ [0, 1]. This is expected by the DETR model.
"""
...
class OrganoidDetectionDataset(Dataset):
    ...
    def __init__(self, dataset_name: str, split: str = "train", h5_path: str | None = None):
        ...
        self.dynamic_size = info["original_size"] is None  # dynamic size
    ...
    def _parse_labels(self, lbl_np: np.ndarray, orig_h: int = None, orig_w: int = None):
        ...
        if self.task == "detection":
            ## we can treat tellu as single class or multi-class depending on the experiments
