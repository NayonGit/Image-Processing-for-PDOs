...
"""
This file contains utility functions for processing bounding boxes and extracting patch targets for the DETR model.
The main functions are:
- box_cxcywh_to_xyxy: Convert bounding boxes from [x_center, y_center, width, height] format to [x_min, y_min, x_max, y_max] format.
- box_xyxy_to_cxcywh: Convert bounding boxes from [x_min, y_min, x_max, y_max] format to [x_center, y_center, width, height] format.
- box_iou: Compute the Intersection over Union (IoU) between two sets of bounding boxes.
- generalized_box_iou: Compute the Generalized IoU between two sets of bounding boxes.
- get_boundaries: Calculate patch boundaries with overlap for image patching.
- extract_patch_targets: Extract targets (boxes and labels) that fall within a specified patch of the image.
"""
# =============================================================================
# Box Utilities
# =============================================================================
