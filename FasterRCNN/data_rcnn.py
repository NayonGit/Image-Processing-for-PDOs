...
DATASET_INFO = {
    ...
    "orgaquant": {
        ...
        "original_size": None,  #  variable size, read dynamically
        "img_size": 512,
        "num_classes": 1,
    },
...
class OrganoidDetectionDataset(Dataset):
    ...
    def __init__(self, dataset_name: str, split: str = "train", h5_path: str | None = None):
        ...
        self.dynamic_size = info["original_size"] is None  # variable size, read dynamically
    ...
    def __getitem__(self, idx: int):
        ...
        # Robust contrast enhancement (1% - 99% percentiles)
    ...
    def _parse_labels(self, lbl_np: np.ndarray, orig_h: int = None, orig_w: int = None):
        """
        Parse raw label array from H5 file into normalised [x1, y1, x2, y2] boxes + class labels.
        ...
        sw = self.img_size / orig_w
        sh = self.img_size / orig_h
