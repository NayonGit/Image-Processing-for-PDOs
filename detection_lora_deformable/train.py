...
from detection_lora_deformable.model import LoRADeformableDetectionModel
...
def train(
    ...
    model = LoRADeformableDetectionModel(
        ...
        nheads=nheads,
        dim_feedforward=hidden_dim * 8, # Standard practice
    ...
    train_loader = DataLoader(
        ...
        collate_fn=LoRADeformableDetectionModel.collate_fn,
        pin_memory=True,
...
def test(
    ...
    model = LoRADeformableDetectionModel.load_from_checkpoint(ckpt_path)
